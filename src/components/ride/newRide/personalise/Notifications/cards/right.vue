...
let notifications = ['PassengerOnBoard', 'EtaUpdate', 'DropOff']
...
<template>
  <div class="column" style="height: fit-content">
    <div class="row">
      <div class="col title">On-route notifications</div>
      <div class="row">
    ...
    <div class="row">
      <div class="col row items-center">Passenger on board</div>
      <div class="row">
        <div class="icons row items-center justify-center">
    ...
    <div class="row">
      <div class="col row items-center">ETA at drop-off</div>
      <div class="row">
        <div class="icons row items-center justify-center">
    ...
    <div class="row">
      <div class="col row items-center">Passenger dropped off</div>
      <div class="row">
        <div class="icons row items-center justify-center">
