...
<template>
  <div class="column" style="position: relative; width: calc(100vw - 544px); gap: 50px">
      ...
      <div class="row" style="width: 100%">
        ...
        <div class="column col-6" style="gap: 40px">
          <div class="column" style="gap: 4px">
            ...
            <div class="text_description">{{ props.name }}@drivania.com</div>
          </div>
        </div>
      </div>
    </div>
    <div>
      ...
      <div style="padding-left: 30px">
        Enabling this feature will allow this recipient to receive alerts for all bookings.
      </div>
    </div>
