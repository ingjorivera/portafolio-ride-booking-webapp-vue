...
<template>
  <div
    class="column"
    style="position: relative; width: calc(100vw - 544px); gap: 16px"
  >
    ...
    <div class="row" style="width: 100%">
      <div class="column col-6" style="gap: 16px">
        ...
        <div class="column" style="gap: 4px">
          <div class="text_boxes">Tax ID</div>
          <div class="text_description">
            <template v-if="props.taxNumber != ''">
              {{ props.taxNumber }}
            </template>
            <template v-else> &nbsp;</template>
          </div>
        ...
        <div class="column" style="gap: 4px">
          <div class="text_boxes">Address</div>
          <div class="text_description">
        ...
        <div class="column" style="gap: 4px">
          <div class="text_boxes">Country/Province</div>
          <div class="text_description">
            <template v-if="props.country_province != ''">
              {{ props.country_province }}
            </template>
            <template v-else> &nbsp;</template>
          </div>
        </div>
      ...
      <div class="column col-6" style="gap: 16px">
        ...
        <div class="column" style="gap: 4px">
          <div class="text_boxes">City</div>

          <div class="text_description">
            <template v-if="props.city != ''">
              {{ props.city }}
            </template>
            <template v-else> &nbsp;</template>
          </div>
        ...
        <div class="column" style="gap: 4px">
          <div class="text_boxes">Postcode</div>

          <div class="text_description">
            <template v-if="props.postcode != ''">
              {{ props.postcode }}
            </template>
            <template v-else> &nbsp;</template>
          </div>
        ...
        <div class="column" style="gap: 4px">
          <div class="text_boxes">Country</div>
