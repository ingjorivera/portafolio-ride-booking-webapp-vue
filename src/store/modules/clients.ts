...
export const useClientsStore = defineStore('clients', {
  state: () => ({
    ...
    selectedContact: ref<ContactsRes>(),
  ...
  actions: {
    ...
    async getPassengers() {
      ...
      try {
        const response = await fetch(
          `${API_URL}/passengers?page=${this.currentPage}&name=${this.searchKeyword}`,
          {
            headers: {
              Authorization: `Bearer ${auth.token}`,
            },
    ...
    async createContact(contactData: ContactsRes) {
      const ui = useUiStore()
      const auth = useAuthStore()
      ...
      try {
        const response = await fetch(`${API_URL}/client-contacs`, {
          method: 'POST',
          headers: {
            Authorization: `Bearer ${auth.token}`,
        ...
        ui.isError = true
        ui.isLoading = false
        ui.errorMessage = 'Error creating contact'
        ui.createNotification(
          ui.errorMessage,
          'negative',
          'top',
    ...
    async searchContactsByName() {
      ...
      try {
        const response = await fetch(
          `${API_URL}/client-contacts?text=${this.searchKeyword}`,
          {
            headers: {
              Authorization: `Bearer ${auth.token}`,
            },
    ...
    async deleteContact(id: string) {
      ...
      try {
        const response = await fetch(`${API_URL}/client-contacts/${id}`, {
          method: 'DELETE',
          headers: {
            Authorization: `Bearer ${auth.token}`,
          },
        ...
        ui.isError = true
        ui.isLoading = false
        ui.errorMessage = 'Error deleting contact'
        ui.createNotification(
          ui.errorMessage,
          'negative',
          'top',
    ...
    async editContact(contactData: ContactsRes) {
      const ui = useUiStore()
      const auth = useAuthStore()

      try {
        const response = await fetch(
          `${API_URL}/client-contacts/${contactData.id}`,
          {
            method: 'PUT',
            headers: {
              Authorization: `Bearer ${auth.token}`,
        ...
        ui.isError = true
        ui.isLoading = false
        ui.errorMessage = 'Error updating contact'
        ui.createNotification(
          ui.errorMessage,
          'negative',
          'top',
